...
## Install chaincode on peer0.InsuranceCompany1 and peer0.InsuranceCompany2
infoln "Installing chaincode on peer0.InsuranceCompany1..."
installChaincode 1
infoln "Install chaincode on peer0.InsuranceCompany2..."
installChaincode 2

## query whether the chaincode is installed
queryInstalled 1

## approve the definition for InsuranceCompany1
approveForMyOrg 1

## check whether the chaincode definition is ready to be committed
## expect InsuranceCompany1 to have approved and InsuranceCompany2 not to
checkCommitReadiness 1 "\"InsuranceCompany1\": true" "\"InsuranceCompany2\": false"
checkCommitReadiness 2 "\"InsuranceCompany1\": true" "\"InsuranceCompany2\": false"

## now approve also for InsuranceCompany2
approveForMyOrg 2

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness 1 "\"InsuranceCompany1\": true" "\"InsuranceCompany2\": true"
checkCommitReadiness 2 "\"InsuranceCompany1\": true" "\"InsuranceCompany2\": true"
